...
def main():
    ...
    #better_draw_circles(4)
    #better_draw_circles(40)


    even_better_draw_circles(rg.Point(100, 50), 5, 10, 'red', 10)
    even_better_draw_circles(rg.Point(50, 200), 10, 20, 'blue', 3)
...
def better_draw_circles(dr):
    ...
    for k in range(1, 11):  # k becomes 1, 2, 3, ... 10
        ...
        turtle.pen_down()
        turtle.draw_circle((15+(dr*(k-1))))  # Radius 15, 30, 45, 60, ...
...
def even_better_draw_circles(point, dr, con_num, color, thicc):
    ...
    for k in range(1, con_num + 1):  # k becomes 1, 2, 3, ... 10
